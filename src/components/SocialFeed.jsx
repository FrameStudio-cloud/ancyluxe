...
function SocialFeed() {
  ...
  return (
    <section id="socials" className="py-20 bg-[#FDF6EF]">
            ...
            >
              ...
              <div className="p-4 bg-gray-50">
                ...
                <a
                  ...
                  className={`block w-full py-2.5 rounded-xl text-sm font-semibold text-white text-center transition-all ${platform.buttonClass}`}
                >
